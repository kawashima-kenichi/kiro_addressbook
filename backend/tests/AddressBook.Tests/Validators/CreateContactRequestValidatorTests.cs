...
public class CreateContactRequestValidatorTests
{
    ...
    {
        var request = new CreateContactRequest { Name = "" };
    ...
    {
        var request = new CreateContactRequest { Name = new string('あ', 101) };
    ...
    public void NameExactly100Characters_ShouldNotHaveError()
    {
        ...
        var request = new CreateContactRequest { Name = name };
    ...
    {
        var request = new CreateContactRequest { Name = "A" };
